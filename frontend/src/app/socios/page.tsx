            ...
            <form onSubmit={handleSaveGestion} className="p-6 space-y-4">
              ...
              <div className="flex gap-3 pt-2">
                ...
                <button 
                  ...
                  className="flex-[2] px-4 py-3 bg-blue-600 text-white rounded-xl text-sm font-bold shadow-lg shadow-blue-200 hover:bg-blue-700 disabled:opacity-50 transition-all"
                >
                  Guardar Gestión
                </button>
              </div>
